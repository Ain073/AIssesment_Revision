...
@section('title', $pageHeading . ' | AIssessment Department Chair')
...
@section('content')
    ...
    <section class="placeholder-grid">
        ...
        <article class="placeholder-card">
            ...
            <p class="text-secondary mb-0">Nasa Department Chair portal na ang structure. Susunod na natin ang scoped data and backend wiring feature by feature.</p>
        </article>
    </section>
@endsection
