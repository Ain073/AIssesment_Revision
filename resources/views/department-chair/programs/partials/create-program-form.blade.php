<div class="modal fade" id="programModal" tabindex="-1" aria-labelledby="programModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form action="{{ route('department-chair.programs.store') }}" class="modal-content" method="POST">
            @csrf
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-psu px-4" type="submit" @disabled(! $scopedDepartment)>Save Program</button>
            </div>
        </form>
    </div>
</div>
