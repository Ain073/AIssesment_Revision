        ...
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('instructor.assessments.destroy', $assessment) }}" class="modal-content" method="POST" data-ajax-form data-remove-target="#assessmentCard{{ $assessment->assessment_id }}">
                ...
                <div class="modal-header">
                    <h3 class="modal-title h4" id="deleteAssessmentModalLabel{{ $assessment->assessment_id }}">Delete Assessment</h3>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger px-4" type="submit">Delete Assessment</button>
                </div>
            </form>
        </div>
    </div>
