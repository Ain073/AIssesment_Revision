...
@section('content')
    ...
    <div data-table-tabs-root data-table-tabs-param="tab" data-table-tabs-default="{{ $activeAssessmentTab }}">
        <div class="table-switch-tabs">
            ...
            <button class="btn btn-outline-primary assessment-tab-button table-switch-button {{ $activeAssessmentTab === 'published' ? 'active' : '' }} d-inline-flex align-items-center gap-2" data-table-tab-button="published" type="button" aria-pressed="{{ $activeAssessmentTab === 'published' ? 'true' : 'false' }}">
        ...
        <section class="{{ $activeAssessmentTab === 'published' ? '' : 'd-none' }}" data-table-tab-panel="published" @if ($activeAssessmentTab !== 'published') hidden @endif>
