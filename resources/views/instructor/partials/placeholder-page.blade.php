...
@section('title', $pageHeading . ' | AIssessment Instructor')
...
@section('content')
    <section class="placeholder-hero">
        <p class="small fw-bold text-uppercase mb-2" style="color: rgba(255,255,255,.72); letter-spacing: .04em;">Instructor Module</p>
    ...
    <section class="placeholder-grid">
        ...
        <article class="placeholder-card">
            ...
            <p class="text-secondary mb-0">Nasa sidebar na ito at handa nang isa-isahin natin ang backend, tables, at actual workflow sa susunod na steps.</p>
        </article>
    </section>
@endsection
